...
public class PermissionHelper {
    ...
    public PermissionHelper(@NonNull Activity activity, Fragment fragment, @NonNull PermissionInterface permissionInterface) {
        mActivity = activity;
        mFragment = fragment;
    ...
    public void checkPermissions() {
        ...
        if (deniedPermissions != null && deniedPermissions.length > 0) {
            PermissionUtil.requestPermissions(mActivity, mFragment, deniedPermissions, mPermissionInterface.getPermissionsRequestCode());
        } else {
